...
def calculation(frame):
    ...
    distance_in_moment = ((left_fitx[199] + right_fitx[199])/2)-150
    # distance_in_moment = -150+(a* 199**2 + b*199 + c)
    # print("distance_in_moment", distance_in_moment)

    derivation1 = 2*a*199 + b
    radian1 = np.arctan(derivation1) 
    degree_in_moment= -np.degrees(radian1)
